...
related_documents:
  ...
  - SW-IMS-POL-001
training:
  course_id: environmental-awareness
  duration: 30
...
- Environmental Procedure: SW-EMS-PRO-001
- Integrated Management System: SW-IMS-POL-001
- Incident Reporting: [Internal system]
...
- **Environmental Policy** (SW-EMS-POL-001): Our commitment and objectives
- **Environmental Procedure** (SW-EMS-PRO-001): Detailed operational procedures
- **IMS Policy** (SW-IMS-POL-001): How environmental management integrates with quality and security
- **Swedish Environmental Code**: https://www.government.se/government-policy/environment/
- **Carbon calculator**: [To be implemented - track personal footprint]
